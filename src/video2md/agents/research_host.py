...
async def research_host(srts: List[str], model: str = "gpt-5-nano") -> List[Dict[str, Any]]:
    """Run the Researcher agent across SRT transcripts and return results per file.
    """
    system_prompt = prompts.load("researcher_instructions")
